...
namespace portalVR
{
	public class DefineManager : EditorWindow
	{
		...
		void OnGUI()
		{
			...
			var text = new string[]
			{
				"Mono Rendering (Non-VR, Hololens)", "AR Foundation (ARKit / ARCore)", "Steam VR (Vive / Rift)",
				"Oculus SDK (Rift / Gear VR)", "ARKit Plugin (Not Recommended)", "ARCore Plugin (Not Recommended)"
			};
